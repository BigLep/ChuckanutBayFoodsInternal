...
public class RecievingInspection implements EntryPoint {
	...
	private void generateUI() {
		...
		flexTable.setWidget(7, 0, lblAllergens);
		
		HorizontalPanel horizontalPanel_2 = new HorizontalPanel();
		horizontalPanel_2.setSpacing(3);
		flexTable.setWidget(7, 1, horizontalPanel_2);
		...
		flexTable.setWidget(10, 0, lblfollowGlassPolicy);
		
		Label lblConditionOfProduct = new Label("Product Condition:");
		flexTable.setWidget(11, 0, lblConditionOfProduct);
		
		HorizontalPanel horizontalPanel_4 = new HorizontalPanel();
		horizontalPanel_4.setSpacing(3);
		flexTable.setWidget(11, 1, horizontalPanel_4);
		...
		flexTable.setWidget(12, 0, lblLotCodesEntered);
		
		HorizontalPanel horizontalPanel_6 = new HorizontalPanel();
		horizontalPanel_6.setSpacing(3);
		flexTable.setWidget(12, 1, horizontalPanel_6);
		...
		mainPanel.add(horizontalPanel_10);
